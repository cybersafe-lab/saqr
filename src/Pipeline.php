...
final class Pipeline
{
     ...
     * corpus additionally guarantees a non-null framework and at least one ref,
     * which bin/corpus-lint enforces. bin/dispatcher.php surfaces refs and
     * framework to MCP clients, so entries must keep those keys.
     *
